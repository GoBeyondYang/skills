...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "report.decision.accept": "Accept — proceed with changes, notify affected parties",
        "report.decision.reject": "Reject — rollback, reason: _______________",
        "report.decision.modify": "Revision needed — adjust approach: _______________",
    ...
    "zh": {
        ...
        "report.decision.accept": "采纳 — 继续执行，同步更新相关方",
        "report.decision.reject": "拒绝 — 回滚变更，原因：_______________",
        "report.decision.modify": "修改建议 — 调整方案：_______________",
